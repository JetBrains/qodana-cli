FROM registry.jetbrains.team/p/sa/containers/qodana:jvm-community-base-252
...
COPY --from=amazoncorretto:11.0.27 /usr/lib/jvm/java-11-amazon-corretto $QODANA_CORETTO_SDK_11
COPY --from=amazoncorretto:17.0.15 /usr/lib/jvm/java-17-amazon-corretto $QODANA_CORETTO_SDK_17
