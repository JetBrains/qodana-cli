...
target "jvm-community" {
  tags = [
    "registry.jetbrains.team/p/sa/containers/qodana:jvm-community-base-251"
  ]
...
target "jvm" {
  ...
  tags = [
    "registry.jetbrains.team/p/sa/containers/qodana:jvm-base-251"
  ]
  platforms = ["linux/amd64", "linux/arm64"]
...
target "python-community" {
  ...
  tags = [
    "registry.jetbrains.team/p/sa/containers/qodana:python-community-base-251"
  ]
  platforms = ["linux/amd64", "linux/arm64"]
...
target "dotnet-community" {
  tags = [
    "registry.jetbrains.team/p/sa/containers/qodana:dotnet-community-base-251"
  ]
  platforms = ["linux/amd64", "linux/arm64"]
...
target "dotnet" {
  ...
  tags = [
    "registry.jetbrains.team/p/sa/containers/qodana:dotnet-base-251"
  ]
  platforms = ["linux/amd64", "linux/arm64"]
