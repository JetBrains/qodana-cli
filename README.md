...
[![TeamCity build status](https://buildserver.labs.intellij.net/app/rest/builds/buildType:id:StaticAnalysis_Base_Nightlyclimain/statusIcon.svg)](https://buildserver.labs.intellij.net/project/StaticAnalysis_Base_Cli?mode=builds)
