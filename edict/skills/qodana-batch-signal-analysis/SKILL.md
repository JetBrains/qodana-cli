...
2. Inspect every work item. Treat an empty PR batch or eligible commit list as a successful no-op.
...
3. Collect only accepted strong signals. Do not create a result, status, explanation, or placeholder for work items without signals.
