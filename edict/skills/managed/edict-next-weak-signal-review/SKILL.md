...
Follow [the managed protocol](../edict_manager/references/protocol.md). Registry ID: `edict-next-weak-signal-review`.
...
Delegate `edict-next-code-example` with `example.write` scoped to this cluster's example directory and no signal-write
