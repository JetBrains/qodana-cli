...
Follow [the managed protocol](../edict_manager/references/protocol.md). Registry ID: `edict-next-generation`. Coordinate
...
For each target create a nested `edict-next-cluster-generation` task. Grant `cluster.write`, `cluster.signal.write`,
