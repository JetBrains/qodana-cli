...
object Registry {
    ...
    val policies: List<Policy> = listOf(
        ...
        Policy(
            "edict-run",
            generation + "inbox.delete",
            delegates = listOf("edict-prepare", "edict-distribution", "edict-generation")
        ),
        Policy("edict-prepare"),
        Policy(
            "edict-distribution",
            listOf("inbox.delete", "cluster.write", "cluster.signal.write"),
            listOf("inbox.delete", "cluster.write", "cluster.signal.write")
        ),
        ...
        Policy(
            ...
            generation,
            listOf("cluster.write", "inspection.write"),
            listOf(
                "edict-code-example",
        ...
        Policy(
            "edict-code-example",
            listOf("example.write", "cluster.signal.write"),
            listOf("example.write", "cluster.signal.write")
        ),
        ...
        Policy(
            "edict-weak-signal-review",
            listOf("example.write", "cluster.signal.write"),
            delegates = listOf("edict-code-example")
        ),
        Policy(
            "edict-batch-signal-analysis",
            listOf("inbox.write"),
    ...
    fun installedName(name: String): String = name
