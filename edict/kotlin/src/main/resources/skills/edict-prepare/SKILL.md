...
`SubmittedFeedback` records are supplied labelled source evidence: require their original message, source reference,
exact file revision and ranges. They have no correcting diff; do not invent commit or PR provenance for them.
